...
public class Aluno {
    ...
    public String getRendimentoEscolar() {
        return rendimentoEscolar;
    }

    public void setRendimentoEscolar(String rendimentoEscolar) {
        this.rendimentoEscolar = rendimentoEscolar;
    }

    public String getHtProjeto() {
        return htProjeto;
    }

    public void setHtProjeto(String htProjeto) {
        this.htProjeto = htProjeto;
    }
